        ...
        <div className="home">
          ...
          <div className="course-curriculum">
            ...
            <div className="course-summary">
              <Input
                placeholder="Search any module/course"
              ...
              {filteredModules.map ((module, index) => {
                return (
                  <Collapse ghost accordion expandIconPosition={'right'}>
                    ...
                    <Panel
                      key={module._id}
                      style={{border: '1px solid #324454'}}
                      header={index + 1 + '. ' + module.name}
                      key={module.index}
                    >
                      {module.courses.map (course => (
                        <Link
                          to={`/${this.props.match.params.type}/course/${course._id}`}
                        >
                          <div key={course._id} className="sub-course">
                            {course.name}
                          </div>
                        </Link>
                      ))}
