...
const { addCourse, getCourse, getParentModule, updateSubModule, deleteSubModule, deleteField } = require('../controllers/course');
...
router.get('/reset/:field/:course_id', deleteField)//isAdmin
